...
export function WarningList(props) {
  ...
  return (
    <table className="planner-table warnings-table">
      <thead>
        <tr>
          <th>#</th>
          <th>Warning</th>
      ...
      <tbody>
        {warnings.map((warns, index) => (
          <tr
            key={warns.msg}
            className={warns.isComplete ? "warning-handled" : "warning-active"}
          >
            <td>{index + 1}</td>
            <td className="warning-message">{warns.msg}</td>
            <td>
              <input
                type="checkbox"
    ...
    <table className="planner-table">
      ...
      <tbody>
        {modules.map((mods, index) => (
          <tr key={mods.code} className={mods.isComplete ? "row-complete" : ""}>
            <td>{index + 1}</td>
            <td className="module-code">{mods.code}</td>
            <td>{mods.grade}</td>
            <td>{mods.mc}</td>
            <td>{mods.workLoad} hrs</td>
            <td>
              <input
                type="checkbox"
                className="planner-checkbox"
  ...
  return (
    ...
    <>
      <div className="Planner">
          ...
          <Typography variant="h2" className="planner-title">
            <span><b>Planner</b></span>
          </Typography>
        ...
        <main className="planner-card">
          ...
          <Box component="form" noValidate onSubmit={handleSubmit} className="planner-form">
            <h2>Plan Modules</h2>
            <Autocomplete
